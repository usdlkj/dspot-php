...
<head>
    ...
    <title>DSpot Registration Confirmation</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        ...
                                        <p>Dear Santa Diver {{ $registration->first_name }} {{ $registration->last_name }}, </p><br />
                                        <p>This email is to confirm your deposit and registration for Santa Dive 2019.</p>
                                        <p>See you in Manado!</p><br />
